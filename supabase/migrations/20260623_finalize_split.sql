-- ─────────────────────────────────────────────────────────────────────────
-- Fase 4 do caixa: pagamento dividido entre formas (split payment).
-- p_splits: jsonb array de [{method: text, amount: numeric}]
-- Se p_splits for fornecido, insere uma cash_transaction por item.
-- Compatível com a versão anterior: se null, usa p_payment_method (1 transação).
-- ─────────────────────────────────────────────────────────────────────────
